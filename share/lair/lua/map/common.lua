...
function where_in_floor_get_x()
        print("  Generator is at Coarse X: " .. (tonumber(generator_coarse_x.x) + tonumber(room_coarse_x.x)) .. " on the floor")
        return tonumber(generator_coarse_x.x) + tonumber(room_coarse_x.x)
end
function where_in_floor_get_y()
        print("  Generator is at Coarse Y: " .. (tonumber(generator_coarse_y.y) + tonumber(room_coarse_y.y)) .." on the floor")
